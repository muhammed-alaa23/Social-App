...
import { AddPostApi, displayAllPosts } from '../services/postServices'
import { addToast } from '@heroui/react'

export default function AddPost({ displayPosts }) {
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                            <button
                                ...
                                type="button"
                                className="px-4 py-2 cursor-pointer text-gray-600 hover:text-gray-800 transition duration-200 disabled:opacity-50"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                type="submit"
                                className="bg-blue-600 text-white px-6 py-2 cursor-pointer rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition duration-200"
                            >
                                {isSubmitting ? (
